...
import {
  extractFirstMediaFromMarkdown,
  stripMarkdownToPreview,
} from '@/lib/blog/media'
import { normalizeHashtag, uniqueHashtags } from '@/lib/blog/tags'
...
export async function GET(_req: NextRequest, ctx: { params: Promise<{ id: string }> }) {
  ...
  const media = extractFirstMediaFromMarkdown(article.contentMd)
  ...
  return NextResponse.json({
    ...
    coverMediaUrl: media?.url ?? null,
    coverMediaType: media?.kind ?? null,
  })
}
